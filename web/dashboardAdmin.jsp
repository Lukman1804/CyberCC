...
<head>
    ...
    <style>
        ...
        #resources .card:nth-child(odd) { background-color: #5ec2a0; }
        #resources .card:nth-child(even) { background-color: #2b8b63; }
        #contact .card:nth-child(odd) { background-color: #e1b12c; color: #222; }
        #contact .card:nth-child(even) { background-color: #c49014; color: #222; }

        .card {
            display: flex; justify-content: space-between; align-items: flex-start;
            margin-bottom: 10px; border-radius: 8px; padding: 20px; color: #fff; text-decoration: none;
        }
        .card-text { flex: 3; }
        ...
        #articles .write-btn { background-color: #3a5998; }
        #articles .write-btn:hover { background-color: #2c4377; }
        #report .write-btn { background-color: #b33939; }
        #report .write-btn:hover { background-color: #902828; }
        #resources .write-btn { background-color: #2b8b63; }
        #resources .write-btn:hover { background-color: #246f4e; }
        #contact .write-btn {
            background-color: #e1b12c;
            color: #222;
            text-decoration: none !important;
        }
        #contact .write-btn:hover { background-color: #c49014; }
        ...
        #contact a { color: #222 !important; text-decoration: none !important; }
    </style>
</head>
<body>
...
<div class="main-content">
    ...
    <div id="articles" class="section active">
        <div style="text-align: right; margin-bottom: 20px;">
            <a href="approveArticle.jsp" class="write-btn">✅ Approve Articles</a>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-meta">
                <p><strong>Writer:</strong> <%= article.getClientID() %></p>
                <p><strong>Date:</strong> <%= article.getArticleDate() %></p>
                <p><strong>Approved by:</strong> <%= article.getAdminID() %></p>
            </div>
        </div>
        <% } } else { %>
    ...
    <div id="report" class="section">
        <div style="text-align: right; margin-bottom: 20px;">
            <a href="approveReport.jsp" class="write-btn">✅ Approve Reports</a>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-meta">
                <p><strong>Reported by:</strong> <%= report.getClientID() %></p>
                <p><strong>Date:</strong> <%= report.getReportDate() %></p>
                <p><strong>Approved by:</strong> <%= report.getAdminID() %></p>
            </div>
        </div>
        <% } } else { %>
    ...
    <div id="resources" class="section">
        <div style="text-align: right; margin-bottom: 20px;">
            <a href="addResource.jsp" class="write-btn">➕ Add Resource</a>
        </div>
        ...
        <div class="btn-group">
            <a href="DeleteResourceServlet?id=<%= res.getResourceID() %>" class="delete-btn" onclick="return confirm('Delete this resource?')">🗑️ Delete</a>
            <a href="EditResourceServlet?id=<%= res.getResourceID() %>" class="edit-btn">✏️ Edit</a>
        </div>
        <% } } else { %>
    ...
    <div id="contact" class="section">
        <div style="text-align: right; margin-bottom: 20px;">
            <a href="addContact.jsp" class="write-btn">➕ Add Contact</a>
        </div>
        ...
        <div class="btn-group">
            <a href="DeleteContactServlet?id=<%= contact.getContactID() %>" class="delete-btn" onclick="return confirm('Delete this contact?')">🗑️ Delete</a>
            <a href="EditContactServlet?id=<%= contact.getContactID() %>" class="edit-btn">✏️ Edit</a>
        </div>
        <% } } else { %>
